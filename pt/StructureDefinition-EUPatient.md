...
* Exemplos para este Perfil: [Patient/PTPatient](Patient-PTPatient.md)
...
Esta estrutura deriva de [Patient](http://hl7.org/fhir/R4/patient.html) 
...
Outras representações do perfil: [CSV](../StructureDefinition-EUPatient.csv), [Excel](../StructureDefinition-EUPatient.xlsx), [Schematron](../StructureDefinition-EUPatient.sch) 
