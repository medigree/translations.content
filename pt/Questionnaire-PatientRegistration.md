...
*  [Vista de árvore](#tabs-tree) 
*  [Exemplo de renderização](#tabs-sample) 
*  [Lógica da forma](#tabs-logic) 

Língua: en

Perfils: `http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-shareablequestionnaire`, `http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-publishablequestionnaire`
...
* linkId: sex
* Respostas: [Multilingual Administrative Gender](ValueSet-PatientRegistration_ml-administrativegendervs.md)
...
### Testar este questionário

Língua: en

Perfils: `http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-shareablequestionnaire`, `http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-publishablequestionnaire`

Experimente este questionário:
...
Atualmente, não existem instâncias de QuestionnaireResponse para este Questionário definidas neste IG.
